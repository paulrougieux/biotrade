...
- `reporter_code`: code of data reporter
- `product_code`: FAO code of the product
- `average_value_reporter_code`: average value of the total annual harvested area related to the specific reporter code, across all the associated products
- `value_percentage_product_code`: percentage value of harvested area related to the specific product code, across all products of the reporter code 
- `average_value_product_code`: average value of the total annual harvested area related to the specific product code, across all the associated reporters
- `value_percentage_reporter_code`: percentage value of harvested area related to the specific reporter code, across all reporters of the product code
- `unit`: measurement units of the data
...
- `reporter_code`: code of data reporter
- `product_code`: FAO code of the product
- `average_value_reporter_code`: average value of the total annual production related to the specific reporter code, across all the associated products
- `value_percentage_product_code`: percentage value of production related to the specific product code, across all products of the reporter code
- `average_value_product_code`: average value of the total annual production related to the specific product code, across all the associated reporters
- `value_percentage_reporter_code`: percentage value of production related to the specific reporter code, across all reporters of the product code
- `unit`: measurement units of the data
...
## faostat_trade_quantity_annual_variation.csv
...
Data taken by Faostat source have year frequency. There are 7 columns:
- `reporter_code`: code of data reporter
...
- `value`: data registered
- `unit`: measurement units of the data
- `flow`: in general can assume two values
    - "import" meaning that the reporter of the quantity is the importer and the partner is the exporter
    - "export" meaning that the reporter of the quantity is the exporter and the partner is the importer

## faostat_trade_quantity_annual_variation_mf.csv
...
## faostat_trade_value_annual_variation.csv
...
- `unit`: measurement units of the data
- `flow`: in general can assume two values
    - "import" meaning that the reporter of the monetary value is the importer and the partner is the exporter
    - "export" meaning that the reporter of the monetary value is the exporter and the partner is the importer

## faostat_trade_value_annual_variation_mf.csv
...
## comtrade_trade_quantity_annual_variation.csv
...
As general rule, data taken by the Comtrade source have year frequency. If there are more updated data with monthly frequency (generally the most recent year) and a lack of yearly data, an aggregation over the last 12 months is performed instead. There are 8 columns:
- `reporter_code`: code of data reporter
- `partner_code`: code of data partner
- `product_code`: FAO code of the product
- `period`: time of data
...
## comtrade_trade_quantity_annual_variation_mf.csv
...
## comtrade_trade_value_annual_variation.csv
...
## comtrade_trade_value_annual_variation_mf.csv
...
## faostat_trade_quantity_average.csv
...
- `period`: aggregation period yyyy-yyyy
- `product_code`: FAO code of the product
- `average_value_product_code`: average value of the total annual trade quantity related to the specific product code, across all the associated reporters
- `unit`: measurement units of the data
- `reporter_code`: code of data reporter
- `value_percentage_reporter_code`: percentage value of trade quantity related to the specific reporter code, across all reporters of the specific product code
- `flow`: in general can assume two values
    - "import" meaning that the reporter of the quantity is the importer
    - "export" meaning that the partner of the quantity is the importer

## faostat_trade_quantity_average_mf.csv
...
- `period`: aggregation period yyyy-yyyy
- `product_code`: FAO code of the product
- `average_value_product_code`: average value of the total annual trade quantity related to the specific product code, across all the associated partners
- `unit`: measurement units of the data
- `partner_code`: code of data partner
- `value_percentage_partner_code`: percentage value of trade quantity related to the specific partner code, across all partners of the specific product code
- `flow`: in general can assume two values
    - "import" meaning that the reporter of the quantity is the importer
    - "export" meaning that the partner of the quantity is the importer

## comtrade_trade_quantity_average.csv
...
## comtrade_trade_quantity_average_mf.csv
...
## faostat_trade_quantity_average_eu_row.csv
...
- `reporter_code`: code of data reporter (aggregation), can assume
    ...
    - "ROW"
- `product_code`: FAO code of the product
- `average_value_product_code`: average value of the total annual trade of the reporter quantity related to the specific product code
- `unit`: measurement units of the data
- `partner_code`: code of data partner
- `value_percentage_partner_code`: percentage value of trade quantity related to the specific partner code, associated to the average value of the product code
- `flow`: in general can assume two values
    - "import" meaning that the reporter of the quantity is the importer
    - "export" meaning that the partner of the quantity is the importer

## faostat_trade_quantity_average_eu_row_mf.csv
...
- `partner_code`: code of data partner (aggregation), can assume
    ...
    - "ROW"
- `product_code`: FAO code of the product
- `average_value_product_code`: average value of the total annual trade of the partner quantity related to the specific product code
- `unit`: measurement units of the data
- `reporter_code`: code of data reporter
- `value_percentage_reporter_code`: percentage value of trade quantity related to the specific reporter code, associated to the average value of the product code
- `flow`: in general can assume two values
    - "import" meaning that the reporter of the quantity is the importer
    - "export" meaning that the partner of the quantity is the importer

## comtrade_trade_quantity_average_eu_row.csv
...
## comtrade_trade_quantity_average_eu_row_mf.csv
